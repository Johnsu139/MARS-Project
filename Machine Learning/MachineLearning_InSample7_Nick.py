...
Performs machine learning on the feature matrices created on Nick's data.
...
featuresAll = np.loadtxt('NickAll.csv',delimiter=',')
featuresAcc = np.loadtxt('NickAcc.csv',delimiter=',')
featuresEda = np.loadtxt('NickEda.csv',delimiter=',')
labels = np.loadtxt('NickLabels.csv',delimiter=',')
groups = np.loadtxt('NickGroups.csv',delimiter=',')
