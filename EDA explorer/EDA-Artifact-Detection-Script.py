''' This code is entirely not mine. It was found open source online and was used for
    computer aided artifact labelling however, it did not produce feasible results '''
